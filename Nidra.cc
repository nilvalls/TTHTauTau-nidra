...
usage()
{
	cerr << "usage: nidra [-caAkmnopPtT] configfile" << endl;
	exit(1);
}

int main(int argc, char **argv){
	bool all = false;
	bool train_comboSelectorSampler = false;
	bool analyze = false;
	bool crunch = false;
