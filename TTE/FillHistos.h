...
// Taus ============================================================================================================================
hContainer->Fill("NumTaus", event->TTE_NumTaus, weightFull);
hContainer->Fill("VisibleMass_TT", event->TTE_DitauVisibleMass->at(iCombo), weightFull);
hContainer->Fill("DeltaR_TT", event->TTE_DitauDeltaR->at(iCombo), weightFull);
hContainer->Fill("Pt_T1", event->TTE_Tau1Pt->at(iCombo), weightFull);
hContainer->Fill("Pt_T2", event->TTE_Tau2Pt->at(iCombo), weightFull);
hContainer->Fill("Eta_T1", event->TTE_Tau1Eta->at(iCombo), weightFull);
hContainer->Fill("Eta_T2", event->TTE_Tau2Eta->at(iCombo), weightFull);
hContainer->Fill("Phi_T1", event->TTE_Tau1Phi->at(iCombo), weightFull);
hContainer->Fill("Phi_T2", event->TTE_Tau2Phi->at(iCombo), weightFull);
hContainer->Fill("DecayMode_T1", event->TTE_Tau1DecayMode->at(iCombo), weightFull);
hContainer->Fill("DecayMode_T2", event->TTE_Tau2DecayMode->at(iCombo), weightFull);
hContainer->Fill("LTPt_T1", event->TTE_Tau1LTPt->at(iCombo), weightFull);
hContainer->Fill("LTPt_T2", event->TTE_Tau2LTPt->at(iCombo), weightFull);
hContainer->Fill("NProngs_T1", event->TTE_Tau1NProngs->at(iCombo), weightFull);
hContainer->Fill("NProngs_T2", event->TTE_Tau2NProngs->at(iCombo), weightFull);
...
hContainer->Fill("DeltaR_ET1", DeltaR(event->TTE_ElectronEta->at(iCombo), event->TTE_ElectronPhi->at(iCombo), event->TTE_Tau1Eta->at(iCombo), event->TTE_Tau1Phi->at(iCombo)), weightFull);
hContainer->Fill("DeltaR_ET2", DeltaR(event->TTE_ElectronEta->at(iCombo), event->TTE_ElectronPhi->at(iCombo), event->TTE_Tau2Eta->at(iCombo), event->TTE_Tau2Phi->at(iCombo)), weightFull);
...
for( unsigned int iJet = 0; iJet < event->J_Pt->size(); iJet++ ) {
    if( (DeltaR( event->J_Eta->at(iJet),
            ...
            event->TTE_Tau1Phi->at(iCombo)) > conesize) &&
        (DeltaR( event->J_Eta->at(iJet),
            event->J_Phi->at(iJet),
            event->TTE_Tau2Eta->at(iCombo),
            event->TTE_Tau2Phi->at(iCombo)) > conesize) &&
        (DeltaR( event->J_Eta->at(iJet),
            event->J_Phi->at(iJet),
            event->TTE_ElectronEta->at(iCombo),
            event->TTE_ElectronPhi->at(iCombo)) > conesize)
    ) {
		if(jetCounter == 0){
			hContainer->Fill("LeadingJet_Pt", event->J_Pt->at(iJet), weightFull);
			hContainer->Fill("DeltaR_MJ1", DeltaR(event->TTE_ElectronEta->at(iCombo), event->TTE_ElectronPhi->at(iCombo), event->J_Eta->at(iJet), event->J_Phi->at(iJet)), weightFull);
			hContainer->Fill("DeltaR_T1J1", DeltaR(event->TTE_Tau1Eta->at(iCombo), event->TTE_Tau1Phi->at(iCombo), event->J_Eta->at(iJet), event->J_Phi->at(iJet)), weightFull);
			hContainer->Fill("DeltaR_T2J1", DeltaR(event->TTE_Tau2Eta->at(iCombo), event->TTE_Tau2Phi->at(iCombo), event->J_Eta->at(iJet), event->J_Phi->at(iJet)), weightFull);
		}else if (jetCounter==1){
			hContainer->Fill("SubLeadingJet_Pt", event->J_Pt->at(iJet), weightFull);
			hContainer->Fill("DeltaR_MJ2", DeltaR(event->TTE_ElectronEta->at(iCombo), event->TTE_ElectronPhi->at(iCombo), event->J_Eta->at(iJet), event->J_Phi->at(iJet)), weightFull);
			hContainer->Fill("DeltaR_T1J2", DeltaR(event->TTE_Tau1Eta->at(iCombo), event->TTE_Tau1Phi->at(iCombo), event->J_Eta->at(iJet), event->J_Phi->at(iJet)), weightFull);
			hContainer->Fill("DeltaR_T2J2", DeltaR(event->TTE_Tau2Eta->at(iCombo), event->TTE_Tau2Phi->at(iCombo), event->J_Eta->at(iJet), event->J_Phi->at(iJet)), weightFull);
		}else{	break; }
...
hContainer->Fill("NumCSVMbtags", event->TTE_NumCSVMbtagJets->at(iCombo), weightFull);
hContainer->Fill("NumCSVTbtags", event->TTE_NumCSVTbtagJets->at(iCombo), weightFull);
hContainer->Fill("NumCSVLnonBtags", event->TTE_NumNonCSVLbtagJets->at(iCombo), weightFull);
hContainer->Fill("NumCSVMnonBtags", event->TTE_NumNonCSVMbtagJets->at(iCombo), weightFull);
hContainer->Fill("NumCSVTnonBtags", event->TTE_NumNonCSVTbtagJets->at(iCombo), weightFull);
hContainer->Fill("NumCSVnonHTauJets", (event->TTE_NumNonCSVMbtagJets->at(iCombo) + event->TTE_NumCSVMbtagJets->at(iCombo)), weightFull);
