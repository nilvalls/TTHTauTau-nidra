	...
	TT_Tau1HPSagainstElectronDeadECAL->clear();
	TT_Tau1HPSagainstElectronLoose->clear();
	TT_Tau1HPSagainstElectronLooseMVA2->clear();
	TT_Tau1HPSagainstElectronLooseMVA3->clear();
	TT_Tau1HPSagainstElectronMVA->clear();
	TT_Tau1HPSagainstElectronMVA2category->clear();
	TT_Tau1HPSagainstElectronMVA2raw->clear();
	TT_Tau1HPSagainstElectronMVA3category->clear();
	TT_Tau1HPSagainstElectronMVA3raw->clear();
	TT_Tau1HPSagainstElectronMedium->clear();
	TT_Tau1HPSagainstElectronMediumMVA2->clear();
	TT_Tau1HPSagainstElectronMediumMVA3->clear();
	TT_Tau1HPSagainstElectronTight->clear();
	TT_Tau1HPSagainstElectronTightMVA2->clear();
	TT_Tau1HPSagainstElectronTightMVA3->clear();
	TT_Tau1HPSagainstElectronVLooseMVA2->clear();
	TT_Tau1HPSagainstElectronVTightMVA3->clear();
	TT_Tau1HPSagainstMuonLoose->clear();
	TT_Tau1HPSagainstMuonLoose2->clear();
	TT_Tau1HPSagainstMuonMedium->clear();
	TT_Tau1HPSagainstMuonMedium2->clear();
	TT_Tau1HPSagainstMuonTight->clear();
	TT_Tau1HPSagainstMuonTight2->clear();
	TT_Tau1HPSbyCombinedIsolationDeltaBetaCorrRaw->clear();
	TT_Tau1HPSbyCombinedIsolationDeltaBetaCorrRaw3Hits->clear();
	TT_Tau1HPSbyIsolationMVA2raw->clear();
	TT_Tau1HPSbyLooseCombinedIsolationDeltaBetaCorr->clear();
	TT_Tau1HPSbyLooseCombinedIsolationDeltaBetaCorr3Hits->clear();
	TT_Tau1HPSbyLooseIsolationMVA->clear();
	TT_Tau1HPSbyLooseIsolationMVA2->clear();
	TT_Tau1HPSbyMediumCombinedIsolationDeltaBetaCorr->clear();
	TT_Tau1HPSbyMediumCombinedIsolationDeltaBetaCorr3Hits->clear();
	TT_Tau1HPSbyMediumIsolationMVA->clear();
	TT_Tau1HPSbyMediumIsolationMVA2->clear();
	TT_Tau1HPSbyTightCombinedIsolationDeltaBetaCorr->clear();
	TT_Tau1HPSbyTightCombinedIsolationDeltaBetaCorr3Hits->clear();
	TT_Tau1HPSbyTightIsolationMVA->clear();
	TT_Tau1HPSbyTightIsolationMVA2->clear();
	TT_Tau1HPSbyVLooseCombinedIsolationDeltaBetaCorr->clear();
	TT_Tau1HPSdecayModeFinding->clear();
	TT_Tau1HPSbyIsolationMVAraw->clear();
	TT_Tau1LTPt->clear();
	TT_Tau1Charge->clear();
	...
	TT_Tau2HPSagainstElectronDeadECAL->clear();
	TT_Tau2HPSagainstElectronLoose->clear();
	TT_Tau2HPSagainstElectronLooseMVA2->clear();
	TT_Tau2HPSagainstElectronLooseMVA3->clear();
	TT_Tau2HPSagainstElectronMVA->clear();
	TT_Tau2HPSagainstElectronMVA2category->clear();
	TT_Tau2HPSagainstElectronMVA2raw->clear();
	TT_Tau2HPSagainstElectronMVA3category->clear();
	TT_Tau2HPSagainstElectronMVA3raw->clear();
	TT_Tau2HPSagainstElectronMedium->clear();
	TT_Tau2HPSagainstElectronMediumMVA2->clear();
	TT_Tau2HPSagainstElectronMediumMVA3->clear();
	TT_Tau2HPSagainstElectronTight->clear();
	TT_Tau2HPSagainstElectronTightMVA2->clear();
	TT_Tau2HPSagainstElectronTightMVA3->clear();
	TT_Tau2HPSagainstElectronVLooseMVA2->clear();
	TT_Tau2HPSagainstElectronVTightMVA3->clear();
	TT_Tau2HPSagainstMuonLoose->clear();
	TT_Tau2HPSagainstMuonLoose2->clear();
	TT_Tau2HPSagainstMuonMedium->clear();
	TT_Tau2HPSagainstMuonMedium2->clear();
	TT_Tau2HPSagainstMuonTight->clear();
	TT_Tau2HPSagainstMuonTight2->clear();
	TT_Tau2HPSbyCombinedIsolationDeltaBetaCorrRaw->clear();
	TT_Tau2HPSbyCombinedIsolationDeltaBetaCorrRaw3Hits->clear();
	TT_Tau2HPSbyIsolationMVA2raw->clear();
	TT_Tau2HPSbyLooseCombinedIsolationDeltaBetaCorr->clear();
	TT_Tau2HPSbyLooseCombinedIsolationDeltaBetaCorr3Hits->clear();
	TT_Tau2HPSbyLooseIsolationMVA->clear();
	TT_Tau2HPSbyLooseIsolationMVA2->clear();
	TT_Tau2HPSbyMediumCombinedIsolationDeltaBetaCorr->clear();
	TT_Tau2HPSbyMediumCombinedIsolationDeltaBetaCorr3Hits->clear();
	TT_Tau2HPSbyMediumIsolationMVA->clear();
	TT_Tau2HPSbyMediumIsolationMVA2->clear();
	TT_Tau2HPSbyTightCombinedIsolationDeltaBetaCorr->clear();
	TT_Tau2HPSbyTightCombinedIsolationDeltaBetaCorr3Hits->clear();
	TT_Tau2HPSbyTightIsolationMVA->clear();
	TT_Tau2HPSbyTightIsolationMVA2->clear();
	TT_Tau2HPSbyVLooseCombinedIsolationDeltaBetaCorr->clear();
	TT_Tau2HPSdecayModeFinding->clear();
	TT_Tau2HPSbyIsolationMVAraw->clear();
	TT_Tau2LTPt->clear();
	TT_Tau2Charge->clear();
	...
	TT_DitauMETMass->clear();
	TT_DitauCosDeltaPhi->clear();
	TT_DitauDeltaR->clear();
	TT_HT->clear();
	TT_NumCSVLbtagJets->clear();
	TT_NumCSVMbtagJets->clear();
	TT_NumCSVTbtagJets->clear();
	TT_NumNonCSVLbtagJets->clear();
	TT_NumNonCSVMbtagJets->clear();
	TT_NumNonCSVTbtagJets->clear();
	TTL_NumTaus = 0;
	TTL_NumMuons = 0;
	TTL_NumElectrons = 0;
	TTL_NumLeptons = 0;
