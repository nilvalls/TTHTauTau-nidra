    ...
    fChain->SetBranchAddress("TTL_CSVeventWeightCErr1up", &TTL_CSVeventWeightCErr1up);
    fChain->SetBranchAddress("TTL_CSVeventWeightCErr1down", &TTL_CSVeventWeightCErr1down);
    fChain->SetBranchAddress("TTL_CSVeventWeightCErr2up", &TTL_CSVeventWeightCErr2up);
    fChain->SetBranchAddress("TTL_CSVeventWeightCErr2down", &TTL_CSVeventWeightCErr2down);
