...
void TTMPlotter::FillHistos(HContainer* iHContainer, DitauBranches* iEvent, bool const iIsMC, Trigger const * iTrigger, PUcorrector const * iPUcorrector, weightCounter* iWeightCounter){
