...
DitauBranches::DitauBranches(){
	...
	Tau1LTIpVtdz				= NULL;
	Tau1LTIpVtd0				= NULL;
	Tau1LTIpVtd0Error			= NULL;
	Tau1LTValidHits				= NULL;
	Tau1LTNormChiSqrd			= NULL;
	Tau2LTIpVtdxy				= NULL;
	Tau2LTIpVtdz				= NULL;
	Tau2LTIpVtd0				= NULL;
	Tau2LTIpVtd0Error			= NULL;
...
fChain->SetBranchAddress("Tau1x", &Tau1x);
fChain->SetBranchAddress("Tau1y", &Tau1y);
fChain->SetBranchAddress("Tau1z", &Tau1z);
fChain->SetBranchAddress("Tau2x", &Tau2x);
fChain->SetBranchAddress("Tau2y", &Tau2y);
fChain->SetBranchAddress("Tau2z", &Tau2z);
...
fChain->SetBranchAddress("Tau1LTIpVtd0", &Tau1LTIpVtd0);
fChain->SetBranchAddress("Tau1LTIpVtd0Error", &Tau1LTIpVtd0Error);
...
fChain->SetBranchAddress("Tau2LTIpVtd0", &Tau2LTIpVtd0);
fChain->SetBranchAddress("Tau2LTIpVtd0Error", &Tau2LTIpVtd0Error);
